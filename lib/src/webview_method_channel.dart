...
class MethodChannelWebViewPlatform implements WebViewPlatformController {
  ...
  MethodChannelWebViewPlatform(int id, this._platformCallbacksHandler)
      : assert(_platformCallbacksHandler != null),
        _channel = MethodChannel('plugins.flutter.io/webview_media_$id') {
  ...
  @override
  Future<void> pauseWebView() => _channel.invokeMethod<void>("pause");

  @override
  Future<void> resumeWebView() => _channel.invokeMethod<void>("resume");
    ...
    return map
      ..addAll({
        ...
        'javascriptChannelNames':
            creationParams.javascriptChannelNames.toList(),
